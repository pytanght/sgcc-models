...
CLASSES = ['站房设备数据储能023_zf_sbsj_cn','站房设备数据分闸指示亮023_zf_sbsj_fzzsl','站房设备数据分闸指示灭023_zf_sbsj_fzzsm','站房设备数据合闸指示亮023_zf_sbsj_hzzsl','站房设备数据合闸指示灭023_zf_sbsj_hzzsm','站房设备数据投入023_zf_sbsj_tr','站房设备数据远方023_zf_sbsj_yf','站房设备数据退出023_zf_sbsj_tc']
# 自动生成xml文件时的标签
cls_score_dict = {'站房设备数据储能023_zf_sbsj_cn':0.60,'站房设备数据分闸指示亮023_zf_sbsj_fzzsl':0.60,'站房设备数据分闸指示灭023_zf_sbsj_fzzsm':0.60,'站房设备数据合闸指示亮023_zf_sbsj_hzzsl':0.60,'站房设备数据合闸指示灭023_zf_sbsj_hzzsm':0.60,'站房设备数据投入023_zf_sbsj_tr':0.60,'站房设备数据远方023_zf_sbsj_yf':0.60,'站房设备数据退出023_zf_sbsj_tc':0.60}
